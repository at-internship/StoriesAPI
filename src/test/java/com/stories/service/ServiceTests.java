...
public class ServiceTests {
	...
	public void getByIdException() throws Exception {
		...
		when(storiesServiceImpl.getStoryById(unitTestProperties.getUrlId())).thenThrow(
	...
	public void getAllStoriesException() throws Exception {
		...
		when(storiesServiceImpl.getAllStories()).thenThrow(
				new EntityNotFoundException(StoriesApiTestsConstants.messageStories, StoriesApiTestsConstants.path));
	}

	@Test
	public void updateStory() throws Exception {
		when(usersClient.existUserById(unitTestProperties.getModelAssigneeId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void updateStorykSpecialChar() throws Exception {
		when(storiesServiceImpl.updateStory(testUtils.getStoryDomainSpecialChar(), unitTestProperties.getDomainId()))
				.thenThrow(
	...
	public void updateStorySpecialsChars() throws Exception {
		when(storiesServiceImpl.updateStory(testUtils.getStoryDomainSpecialsChars(), unitTestProperties.getDomainId()))
				.thenThrow(new EntityNotFoundException("The next field have special characters: Status, assignee", "",
						"/stories/"));
	...
	public void updateStoryStatusException() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainStatusInvalid().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createTask() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(testUtils.getTasksDomain().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(storiesRepository.findById(unitTestProperties.getModelId()))
				.thenReturn(Optional.of(TestUtils.getStoryModel()));
	...
	public void createTaskSpecialChar() throws Exception {
		when(storiesServiceImpl.createTask(testUtils.getTaskDomainSpecialChar(), unitTestProperties.getModelId()))
				.thenThrow(
						new EntityNotFoundException("The next field have special characters: Status", "", "/stories/"));
	...
	public void createTaskSpecialsChars() throws Exception {
		when(storiesServiceImpl.createTask(testUtils.getTaskDomainSpecialsChars(), unitTestProperties.getModelId()))
				.thenThrow(new EntityNotFoundException("The next field have special characters: Status, assignee", "",
						"/stories/"));
	...
	public void createTaskStoryExistException() throws Exception {
		...
		when(storiesServiceImpl.createTask(TestUtils.getTasksDomain(), unitTestProperties.getModelId()))
				.thenThrow(new EntityNotFoundException(StoriesApiTestsConstants.messageStory, HttpStatus.CONFLICT,
						StoriesApiTestsConstants.path));
	}
	...
	public void createTaskUserExistException() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(TestUtils.getDummyTasksDomain().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanFalse);
		when(storiesServiceImpl.createTask(testUtils.getTasksDomain(), unitTestProperties.getModelId()))
				.thenThrow(new EntityNotFoundException(StoriesApiTestsConstants.messageStory, HttpStatus.CONFLICT,
						StoriesApiTestsConstants.path));
	...
	public void createTaskStatusException() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(testUtils.getTasksDomainStatusValid().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createTaskStatusNullException() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(testUtils.getTasksStatusNullDomain().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(storiesRepository.findById(unitTestProperties.getModelId()))
				.thenReturn(Optional.of(TestUtils.getStoryModel()));
	...
	public void createStorySprintIdException() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainAssigneInvalid().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		...
		when(storiesServiceImpl.createStory(testUtils.getStoryDomainAssigneInvalid())).thenThrow(
				new EntityNotFoundException(StoriesApiTestsConstants.messageSprintId, StoriesApiTestsConstants.path));
		storiesServiceImpl.createStory(testUtils.getStoryDomainAssigneInvalid());
	}

	@Test(expected = EntityNotFoundException.class)
	public void createStoryNameInvalid() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainNameInvalid().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createStoryStatusInvalid() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainStatusNull().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createStartDateNull() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainStarDateNull().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createPointsProggresNegative() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainPointsProggresNegative().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void createPointsProgressInvalid() throws Exception {
		when(usersClient.existUserById(testUtils.getStoryDomainPointsProgressInvalid().getAssignee_id()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
	...
	public void getTasksByStoryFail() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getUrlId()))
				.thenReturn(StoriesApiTestsConstants.booleanFalse);
		when(storiesServiceImpl.getTasksByStory(unitTestProperties.getUrlId())).thenThrow(new EntityNotFoundException(
				StoriesApiTestsConstants.messageStory, StoriesApiTestsConstants.path + unitTestProperties.getUrlId()));
	...
	public void updateStorySpecialChar() throws Exception {
		when(storiesServiceImpl.updateTaskById(testUtils.getTaskDomainSpecialChar(), unitTestProperties.getModelId(),
				testUtils.getTaskModelId().get_id())).thenThrow(
						new EntityNotFoundException("The next field have special characters: Status", "", "/stories/"));
	...
	public void updateTaskSpecialsChars() throws Exception {
		when(storiesServiceImpl.updateTaskById(testUtils.getTaskDomainSpecialsChars(), unitTestProperties.getModelId(),
				testUtils.getTaskModelId().get_id())).thenThrow(
						new EntityNotFoundException("The next field have special characters: Status, assignee", "",
								"/stories/"));
		storiesServiceImpl.updateTaskById(testUtils.getTaskDomainSpecialsChars(), unitTestProperties.getModelId(),
				testUtils.getTaskModelId().get_id());
	}
	...
	public void updateTaskByIdStatusValidation() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		storiesServiceImpl.updateTaskById(testUtils.getUpdateTaskDomainWrongstatus(), unitTestProperties.getModelId(),
				StoriesApiTestsConstants.ValidPutTaskId);
	}
	...
	public void updateTaskbyIdInvalidAsignee() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(testUtils.getUpdateTaskDomainAssignee().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanFalse);
	...
	public void updateTaskbyIdNameEmpty() throws Exception {
		when(storiesRepository.existsById(unitTestProperties.getModelId()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		when(usersClient.existUserById(testUtils.getUpdateTaskDomainNameEmpty().getAssignee()))
				.thenReturn(StoriesApiTestsConstants.booleanTrue);
		storiesServiceImpl.updateTaskById(testUtils.getUpdateTaskDomainNameEmpty(), unitTestProperties.getModelId(),
				StoriesApiTestsConstants.ValidPutTaskId);
	}
